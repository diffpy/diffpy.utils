...
@pytest.mark.parametrize(
    ...
    [
        ...
        (  # C5.1: Reuse test case from C1, none of q, tth, d, provided, but
            # include an offset, expect scaled y-array in C1 to shift up
            # by 2
            {
                "xarray": np.array([0.1, 0.2, 0.3]),
                "yarray": np.array([1, 2, 3]),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (  # C3: Minimum arguments provided for init with non-empty values for
            # xarray and yarray and wavelength expect all attributes set
            # without None
            {
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (  # C1: No arguments provided, expect 3 required positional arguments
            # error
            {},
            (
        ...
        (  # C2: Only xarray and yarray provided, expect 1 required positional
            # argument error
